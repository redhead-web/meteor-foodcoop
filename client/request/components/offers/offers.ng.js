function OffersCtrl($scope, $reactive) {
  var vm = this;
  ...
  vm.reqUpdate = reqUpdate;
  
  function update(offer, modifier) {
    var idx = _.indexOf(vm.offers, offer);
    _.merge(vm.offers[idx], modifier.$set)
  ...
  function reqUpdate(modifier) {
    vm.requestUpdate({request: vm.request, modifier: modifier});
  }
  
  
}

angular.module('food-coop').component('offers', {
  templateUrl: 'client/request/components/offers/offers.ng.html',
